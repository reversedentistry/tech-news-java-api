...
public class HomePageController {
    ...
    /*addAttribute() sends info to Thymeleaf templates. This sends newly
        created user to template as string user to be display on template
        .Once logged in, user redirected to / route*/
